...
from rasa_nlu_gao.models.nlp_architect.utils.text import SpacyInstance, Vocabulary, character_vector_generator, \
...
class IntentDataset(object):
    ...
    def _load_data(self, train_set):
        # vectorize
        # add offset of 2 for PAD and OOV
        train_size = len(train_set)
        #test_size = len(test_set)
        texts, tags, intents = list(zip(*train_set))
